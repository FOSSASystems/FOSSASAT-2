...
#define ADCS_COIL_CHARACTERISTICS                       { {893.655,     0,       0}, \
                                                          {     0, 15.833,       0}, \
                                                          {     0,      0, 108.552} }
#define ADCS_PANEL_UNIT_VECTOR                          { {0.5,    0,    0, -0.5,    0,    0}, \
                                                          {0,    0.5,    0,    0, -0.5,    0}, \
                                                          {0,      0,  0.5,    0,    0, -0.5} }
#define ADCS_DEFAULT_CONTROLLER                         { {-3.675908E-14, -1.732647E-11, -5.770725E-12, -2.213699E-09, 1.667291E-10, -6.587849E-16}, \
                                                          {-1.000806E-11, 4.034582E-13, -2.135005E-09, 5.154743E-11, 4.539379e-08, 9.587663E-18}, \
                                                          {2.059787E-12, 3.671363E-09, 5.996647E-13, 4.690679E-07, -9.342622E-09, 1.395888E-13} }
